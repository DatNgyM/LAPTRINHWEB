    ...
    public class TourDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TourImage>(entity =>
            {
                ...
                // Quan hệ: TourImage belongs to Tour
            ...
            modelBuilder.Entity<Itinerary>(entity =>
            {
                ...
                // Quan hệ: Itinerary belongs to Tour
                entity.HasOne(d => d.Tour)
                    .WithMany()
                    .HasForeignKey(d => d.ID_Tour)
                    .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity<TourAccommodation>(entity =>
            {
                ...
                // Quan hệ: TourAccommodation belongs to Tour
                entity.HasOne(d => d.Tour)
                    .WithMany()
                    .HasForeignKey(d => d.ID_Tour)
                    .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity<TourTransport>(entity =>
            {
                ...
                // Quan hệ: TourTransport belongs to Tour
                entity.HasOne(d => d.Tour)
                    .WithMany()
                    .HasForeignKey(d => d.ID_Tour)
                    .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity<TourGuideAssignment>(entity =>
            {
                ...
                // Quan hệ: TourGuideAssignment belongs to Tour
                entity.HasOne(d => d.Tour)
                    .WithMany()
                    .HasForeignKey(d => d.ID_Tour)
                    .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity<Booking>(entity =>
            {
                ...
                // Quan hệ: Booking belongs to Tour
                entity.HasOne(d => d.Tour)
                    .WithMany(p => p.Bookings)
                    .HasForeignKey(d => d.ID_Tour)
                    .OnDelete(DeleteBehavior.Cascade);
